...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"style="display:flex; align-items:center;justify-content:center; font-size:24px"><b>{{ __('REGISTER') }}</b></div>
                ...
                <div class="card-body">
                   ...
                   <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                    name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="RegNo" class="col-md-4 col-form-label text-md-end">{{ __('RegNo') }}</label>
                        
                            <div class="col-md-6">
                                <input id="RegNo" type="text" class="form-control @error('RegNo') is-invalid @enderror" name="RegNo"
                                    value="{{ old('RegNo') }}" required autocomplete="RegNo" autofocus>
