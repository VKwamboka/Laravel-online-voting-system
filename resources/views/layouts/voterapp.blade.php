...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <div class="nav-item">
        <a class="nav-link" href="#" role="button">
            <button type="Logout" class="btn btn-primary">
                {{ __('Logout') }}
            </button>
    </ul>
  </nav>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="adminDashBoard.blade" class="brand-link">
      {{-- <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" style="opacity: .8"> --}}
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a  href="{{ URL::to("votes") }}"  class="nav-link">
